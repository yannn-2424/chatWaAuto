...
export const QrCode = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4m0-6v3m6 0v3m0-6h2m-6 0h2m0-6V7m0 0h2v2h-2V7zm0 0H9m12 0h-2V5h2v2zM5 5h2v2H5V5zm0 12h2v2H5v-2zM5 9h2v2H5V9zm12 0h2v2h-2V9zm-4-4h2v2h-2V5zm0 4h2v2h-2V9z" />
  </svg>
);
